        ...
        <div class="container doc-pro-container">
            <div class="row">
                ...
                <div class="col-md-4 doc-pro-sidebar">
                    <img src="<?php echo htmlspecialchars($dropdownProfilePicture); ?>" alt="Profile Picture" class="doc-pro-profile-img">
                ...
                <div class="col-md-8">
                    ...
                    <div class="text-center mt-4">
                        <a href="doc-edit-profile.php" class="btn btn-success doc-pro-edit-btn">
